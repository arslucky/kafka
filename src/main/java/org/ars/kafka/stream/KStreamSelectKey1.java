 ...
 *
 */
public class KStreamSelectKey1 {

    static Logger log = LogManager.getLogger( KStreamSelectKey1.class);

    static String topic = KStreamSelectKey1.class.getSimpleName();
    ...
    static class Consumer implements Runnable {
        ...
        public void run() {
            try {
                ...
                KStream<Integer, Integer> stream1 = stream.selectKey( ( key, value) -> value); // set value as a key
