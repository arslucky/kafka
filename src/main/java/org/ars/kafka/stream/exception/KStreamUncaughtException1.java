package org.ars.kafka.stream.exception;
 ...
 *
 */
public class KStreamUncaughtException1 {

    static Logger log = LogManager.getLogger( KStreamUncaughtException1.class);

    static String topic = KStreamUncaughtException1.class.getSimpleName();
        ...
        public void run() {
            try {
                ...
                streams.setUncaughtExceptionHandler( ( ex) -> {
                    log.error( "thread:{}, error message: {}", currentThread().getName(), ex);
