 ...
 *
 */
public class KStreamStateListener1 {

    static Logger log = LogManager.getLogger( KStreamStateListener1.class);

    static String topic = KStreamStateListener1.class.getSimpleName();
