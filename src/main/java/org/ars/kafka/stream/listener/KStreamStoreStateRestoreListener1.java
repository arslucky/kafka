package org.ars.kafka.stream.listener;
...
import org.ars.kafka.stream.processor.KProcessor1;

/**
 * @author arsen.ibragimov
 *
 * delete local store on a disk and run application again
 */
public class KStreamStoreStateRestoreListener1 {

    static Logger log = LogManager.getLogger( KStreamStoreStateRestoreListener1.class);

    static String topic = KStreamStoreStateRestoreListener1.class.getSimpleName();
    ...
    static class StateRestoreListener1 implements StateRestoreListener {

        @Override
        public void onRestoreStart( TopicPartition topicPartition, String storeName, long startingOffset, long endingOffset) {
            log.info( "onRestoreStart, storeName:{}, startingOffset:{}, endingOffset:{}", storeName, startingOffset, endingOffset);
        }

        @Override
        public void onBatchRestored( TopicPartition topicPartition, String storeName, long batchEndOffset, long numRestored) {
            log.info( "onBatchRestored, storeName:{}, numRestored:{}", storeName, numRestored);
        }

        @Override
        public void onRestoreEnd( TopicPartition topicPartition, String storeName, long totalRestored) {
            log.info( "onRestoreEnd, storeName:{}, totalRestored:{}", storeName, totalRestored);
        }
    ...
    static class Consumer implements Runnable {
        ...
        public void run() {
            try {
                ...
                builder.<Integer, Integer>stream( topic).groupByKey().reduce( ( val1, val2) -> val1 + val2, Materialized.as( "store"));
                ...
                streams.setGlobalStateRestoreListener( new StateRestoreListener1());
